...
async function getProducts() {
  ...
  renderSlider(0, 'slide-left', productsArray);
}
...
function renderSlider(itemNum, way, productsArray) {
  let item = productsArray[itemNum];
  const productHTML = `
  ...
  if (way === 'slide-left') {
    productsSlider.insertAdjacentHTML('afterbegin', productHTML);
  } else if (way === 'slide-right') {
